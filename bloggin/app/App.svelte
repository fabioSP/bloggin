...
<script>
  ...
  import Agenda from './Components/Home/Agenda.svelte'
  import Campanhas from './Components/Home/Campanhas.svelte'
  import Parceiros from './Components/Home/Parceiros.svelte'
